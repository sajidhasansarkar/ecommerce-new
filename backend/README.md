...
- `IMGBB_API_KEY` → ছবি আপলোডের জন্য। ফ্রি API key নিন এখান থেকে: https://api.imgbb.com/
  (লগইন করে "Get API Key" এ ক্লিক করলেই key পেয়ে যাবেন)
...
| POST | `/api/upload` | ছবি imgbb-তে আপলোড করে লিংক রিটার্ন করে | অ্যাডমিন |
